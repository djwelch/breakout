...
breakout.core.get_background_color = function get_background_color() {
  return getComputedStyle(document.body).backgroundColor
};
breakout.core.clear = function clear(width, height, context) {
  context.fillStyle = breakout.core.get_background_color.call(null);
  context.fillRect(0, 0, width, height);
  context.beginPath();
  context.rect(0, 0, width, height);
  return context.stroke()
};
breakout.core.draw = function() {
  ...
  return new cljs.core.MultiFn("draw", new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "default", "default", 2558708147), hierarchy__3905__auto__, method_table__3901__auto__, prefer_table__3902__auto__, method_cache__3903__auto__, cached_hierarchy__3904__auto__)
}();
cljs.core._add_method.call(null, breakout.core.draw, new cljs.core.Keyword(null, "block", "block", 1107736575), function(object, context) {
  var map__8569 = object;
  var map__8569__$1 = cljs.core.seq_QMARK_.call(null, map__8569) ? cljs.core.apply.call(null, cljs.core.hash_map, map__8569) : map__8569;
  var color = cljs.core.get.call(null, map__8569__$1, new cljs.core.Keyword(null, "color", "color", 1108746965));
  var width = cljs.core.get.call(null, map__8569__$1, new cljs.core.Keyword(null, "width", "width", 1127031096));
  var height = cljs.core.get.call(null, map__8569__$1, new cljs.core.Keyword(null, "height", "height", 4087841945));
  var top = cljs.core.get.call(null, map__8569__$1, new cljs.core.Keyword(null, "top", "top", 1014019271));
  var left = cljs.core.get.call(null, map__8569__$1, new cljs.core.Keyword(null, "left", "left", 1017222009));
  context.beginPath();
...
cljs.core._add_method.call(null, breakout.core.draw, new cljs.core.Keyword(null, "bat", "bat", 1014001543), function(object, context) {
  var map__8570 = object;
  var map__8570__$1 = cljs.core.seq_QMARK_.call(null, map__8570) ? cljs.core.apply.call(null, cljs.core.hash_map, map__8570) : map__8570;
  var color = cljs.core.get.call(null, map__8570__$1, new cljs.core.Keyword(null, "color", "color", 1108746965));
  var width = cljs.core.get.call(null, map__8570__$1, new cljs.core.Keyword(null, "width", "width", 1127031096));
  var height = cljs.core.get.call(null, map__8570__$1, new cljs.core.Keyword(null, "height", "height", 4087841945));
  var left = cljs.core.get.call(null, map__8570__$1, new cljs.core.Keyword(null, "left", "left", 1017222009));
  var canvas = document.getElementById("canvas");
  var canvasHeight = canvas.height;
  context.fillStyle = color;
  return context.fillRect(left, canvasHeight - height, width, height)
});
cljs.core._add_method.call(null, breakout.core.draw, new cljs.core.Keyword(null, "ball", "ball", 1016920433), function(object, context) {
  var map__8571 = object;
  ...
  var color = cljs.core.get.call(null, map__8571__$1, new cljs.core.Keyword(null, "color", "color", 1108746965));
  var radius = cljs.core.get.call(null, map__8571__$1, new cljs.core.Keyword(null, "radius", "radius", 4370292740));
  var x = cljs.core.get.call(null, map__8571__$1, new cljs.core.Keyword(null, "x", "x", 1013904362));
  var y = cljs.core.get.call(null, map__8571__$1, new cljs.core.Keyword(null, "y", "y", 1013904363));
  context.beginPath();
  context.arc(x, y, radius, 0, 2 * 3.14159);
  context.fillStyle = color;
  return context.fill()
});
cljs.core._add_method.call(null, breakout.core.draw, new cljs.core.Keyword(null, "empty", "empty", 1110538431), function(object, context) {
  return null
});
breakout.core.block_line = function block_line(state, width, top) {
  var block_width = width / cljs.core.count.call(null, state);
  var assocfn = function(block_width) {
    return function(p1__8572_SHARP_, p2__8573_SHARP_) {
      return cljs.core.assoc.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "block", "block", 1107736575), new cljs.core.Keyword(null, "color", "color", 1108746965), p1__8572_SHARP_, new cljs.core.Keyword(null, "top", "top", 1014019271), top, new cljs.core.Keyword(null, "width", "width", 1127031096), block_width, new cljs.core.Keyword(null, "height", "height", 4087841945), 20], true), new cljs.core.Keyword(null, 
      "left", "left", 1017222009), p2__8573_SHARP_ * block_width)
    }
  }(block_width);
  return cljs.core.map.call(null, function(p1__8574_SHARP_) {
    if(cljs.core.truth_(cljs.core.get.call(null, p1__8574_SHARP_, 0))) {
      return assocfn.call(null, cljs.core.get.call(null, p1__8574_SHARP_, 0), cljs.core.get.call(null, p1__8574_SHARP_, 1))
    }else {
      return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "empty", "empty", 1110538431)], true)
    }
  }, cljs.core.map.call(null, cljs.core.vector, state, cljs.core.range.call(null)))
};
breakout.core.blocks = function blocks(state, width) {
  return cljs.core.reduce.call(null, cljs.core.concat, cljs.core.PersistentVector.EMPTY, cljs.core.map.call(null, function(p1__8575_SHARP_) {
    return breakout.core.block_line.call(null, cljs.core.get.call(null, p1__8575_SHARP_, 0), width, 40 + cljs.core.get.call(null, p1__8575_SHARP_, 1) * 20)
  }, cljs.core.map.call(null, cljs.core.vector, state, cljs.core.range.call(null))))
};
breakout.core.ball = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "ball", "ball", 1016920433), new cljs.core.Keyword(null, "color", "color", 1108746965), "white", new cljs.core.Keyword(null, "radius", "radius", 4370292740), 5, new cljs.core.Keyword(null, "x", "x", 1013904362), 200, new cljs.core.Keyword(null, "y", "y", 1013904363), 200], true);
breakout.core.bat = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "bat", "bat", 1014001543), new cljs.core.Keyword(null, "color", "color", 1108746965), "black", new cljs.core.Keyword(null, "left", "left", 1017222009), 50, new cljs.core.Keyword(null, "width", "width", 1127031096), 50, new cljs.core.Keyword(null, "height", "height", 4087841945), 20], true);
breakout.core.tick = function tick() {
  return console.log("tick")
};
breakout.core.init = function init() {
  var canvas = document.getElementById("canvas");
  var context = canvas.getContext("2d");
  var width = canvas.width;
  var height = canvas.height;
  var state = cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["green", "blue", "yellow", "red", "green"], true), cljs.core.PersistentVector.fromArray(["green", "blue", "yellow", "red", "green"], true), cljs.core.PersistentVector.fromArray(["green", "blue", "yellow", "red", "green"], true), cljs.core.PersistentVector.fromArray(["green", "blue", "yellow", "red", "green"], true), cljs.core.PersistentVector.fromArray(["yellow", "green", "blue", "red", "green"], true)], true);
  breakout.core.clear.call(null, width, height, context);
  var seq__8580_8584 = cljs.core.seq.call(null, cljs.core.concat.call(null, breakout.core.blocks.call(null, state, width), cljs.core.PersistentVector.fromArray([breakout.core.ball, breakout.core.bat], true)));
  var chunk__8581_8585 = null;
  var count__8582_8586 = 0;
  var i__8583_8587 = 0;
  while(true) {
    if(i__8583_8587 < count__8582_8586) {
      var object_8588 = cljs.core._nth.call(null, chunk__8581_8585, i__8583_8587);
      breakout.core.draw.call(null, object_8588, context);
      ...
      var temp__4092__auto___8593 = cljs.core.seq.call(null, seq__8580_8584);
      if(temp__4092__auto___8593) {
        var seq__8580_8594__$1 = temp__4092__auto___8593;
        if(cljs.core.chunked_seq_QMARK_.call(null, seq__8580_8594__$1)) {
          var c__3844__auto___8595 = cljs.core.chunk_first.call(null, seq__8580_8594__$1);
          var G__8596 = cljs.core.chunk_rest.call(null, seq__8580_8594__$1);
          var G__8597 = c__3844__auto___8595;
          var G__8598 = cljs.core.count.call(null, c__3844__auto___8595);
          var G__8599 = 0;
          ...
          var object_8600 = cljs.core.first.call(null, seq__8580_8594__$1);
          breakout.core.draw.call(null, object_8600, context);
  ...
  return setInterval(breakout.core.tick, 1E3)
};
